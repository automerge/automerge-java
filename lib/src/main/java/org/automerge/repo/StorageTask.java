...
/**
 * Represents a storage operation task in the samod-core system. This is an
 * abstract base class with concrete subclasses for each operation type.
 */
abstract class StorageTask {

    /**
     * A storage task to load a single value by key.
     */
    static class Load extends StorageTask {
     ...
     */
    static class LoadRange extends StorageTask {
     ...
     */
    static class Put extends StorageTask {
     ...
     */
    static class Delete extends StorageTask {
