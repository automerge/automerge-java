...
/**
 * The state of a network connection. This is an abstract base class with
 * concrete subclasses for each state.
 */
public abstract class ConnectionState {
    ...
    public static class Connected extends ConnectionState {
        ...
        Connected(PeerId theirPeerId) {
            this.theirPeerId = Objects.requireNonNull(theirPeerId, "theirPeerId cannot be null");
        }
        ...
        @Override
        public String toString() {
            return ("ConnectionState.Connected{" + "theirPeerId=" + theirPeerId + "}");
        }
    }
}
