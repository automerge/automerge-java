...
public class ConnectionInfo {
    ...
    ConnectionInfo(ConnectionId id, Optional<Instant> lastReceived, Optional<Instant> lastSent,
            Map<DocumentId, PeerDocState> docs, ConnectionState state) {
    ...
    public boolean equals(Object obj) {
        ...
        return (Objects.equals(id, that.id) && Objects.equals(lastReceived, that.lastReceived)
                && Objects.equals(lastSent, that.lastSent) && Objects.equals(docs, that.docs)
    ...
    public String toString() {
        return ("ConnectionInfo{" + "id=" + id + ", lastReceived=" + lastReceived + ", lastSent=" + lastSent + ", docs="
                + docs + ", state=" + state + "}");
    }
}
