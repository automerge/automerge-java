...
/**
 * Represents a message that should be sent to a document actor. Contains the
 * target actor ID and the message to be delivered.
 */
class ActorMessage {
    ...
    /**
     * Creates an ActorMessage with the given actor ID and message. Package-private
     * constructor - only called from JNI layer.
     *
     * @param actorId
     *            The target document actor ID
     * @param message
    ...
    public boolean equals(Object obj) {
        ...
        return (Objects.equals(actorId, that.actorId) && Objects.equals(message, that.message));
    }
