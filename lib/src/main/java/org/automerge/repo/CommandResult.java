...
/**
 * Represents the result of a completed command. This is an abstract base class
 * with concrete subclasses for each result type.
 */
abstract class CommandResult {
     ...
     */
    static class CreateConnection extends CommandResult {
     ...
     */
    static class DisconnectConnection extends CommandResult {
     ...
     */
    static class Receive extends CommandResult {

        private final ConnectionId connectionId;
        private final Optional<String> error;

        Receive(ConnectionId connectionId, Optional<String> error) {
            this.connectionId = Objects.requireNonNull(connectionId, "connectionId cannot be null");
        ...
        public boolean equals(Object obj) {
            ...
            return (Objects.equals(connectionId, receive.connectionId) && Objects.equals(error, receive.error));
        }
        ...
        @Override
        public String toString() {
            return ("CommandResult.Receive{connectionId=" + connectionId + ", error=" + error + "}");
        }
    }
     ...
     */
    static class ActorReady extends CommandResult {
     ...
     */
    static class CreateDocument extends CommandResult {
        ...
        public boolean equals(Object obj) {
            ...
            return (Objects.equals(actorId, that.actorId) && Objects.equals(documentId, that.documentId));
        }
        ...
        @Override
        public String toString() {
            return ("CommandResult.CreateDocument{actorId=" + actorId + ", documentId=" + documentId + "}");
        }
    }
     ...
     */
    static class FindDocument extends CommandResult {
        ...
        @Override
        public String toString() {
            return ("CommandResult.FindDocument{actorId=" + actorId + ", found=" + found + "}");
        }
    }

    /**
     * Result of an AddDialer command.
     */
    static class AddDialer extends CommandResult {

        private final DialerId dialerId;

        AddDialer(DialerId dialerId) {
            this.dialerId = Objects.requireNonNull(dialerId, "dialerId cannot be null");
        }
        ...
        @Override
        public String toString() {
            return ("CommandResult.AddDialer{dialerId=" + dialerId + "}");
        }
    }

    /**
     * Result of an AddListener command.
     */
    static class AddListener extends CommandResult {

        private final ListenerId listenerId;

        AddListener(ListenerId listenerId) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj == null || getClass() != obj.getClass())
                return false;
            AddListener that = (AddListener) obj;
        ...
        @Override
        public String toString() {
            return ("CommandResult.AddListener{listenerId=" + listenerId + "}");
        }
    }
}
