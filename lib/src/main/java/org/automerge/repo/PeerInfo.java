...
/**
 * Information about a connected peer after successful handshake. Contains the
 * peer's identity, metadata, and protocol version.
 */
public class PeerInfo {
     ...
     *
     * @param peerId
     *                        Unique identifier for the peer in the sync network
     * @param metadata
     *                        Optional metadata about the peer from the handshake
     * @param protocolVersion
     *                        Protocol version used by the peer
     */
    PeerInfo(PeerId peerId, Optional<PeerMetadata> metadata, String protocolVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        return (Objects.equals(peerId, peerInfo.peerId) && Objects.equals(metadata, peerInfo.metadata)
    ...
    public String toString() {
        return ("PeerInfo{" + "peerId=" + peerId + ", metadata=" + metadata + ", protocolVersion='" + protocolVersion
                + '\'' + '}');
    }
}
