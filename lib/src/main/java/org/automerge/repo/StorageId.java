...
/**
 * Represents a storage ID in the samod network protocol. StorageId is a UUID
 * string wrapper that is only created by Rust code.
 */
public class StorageId {
    ...
    /**
     * Creates a StorageId with the given string value. Package-private constructor
     * - only called from JNI layer.
     *
     * @param value
     *            The storage ID string
     */
    StorageId(String value) {
        this.value = Objects.requireNonNull(value, "StorageId value cannot be null");
    }
